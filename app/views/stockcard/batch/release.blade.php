		...
		<div class="panel-body">
			...
			<div class="col-md-12">
				...
				{{ Form::text('quantity','',[
					...
					<button type="button" id="cancel" class="btn btn-md btn-default"><span class="glyphicon glyphicon-share-alt"></span> Cancel</button>
			...
			<div class="btn-group pull-right">
				<div class="btn-group">
					<button type="button" id="release" class="btn btn-md btn-primary btn-block"><span class="glyphicon glyphicon-share-alt"></span> Release</button>
				</div>
			</div>
			{{ Form::close() }}
		</div>
