...
@endsection
@section('content')
{{ Form::open(array('class' => 'form-horizontal','method'=>'post','route'=>'maintenance.office.store','id'=>'officeForm')) }}
    ...
    <div class="col-md-offset-3 col-md-6">
      <div class="panel panel-body ">
        ...
        <div id="page-one">
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <button id="submit" class="btn btn-block btn-lg btn-md btn-primary" type="button" style="padding:10px;">
